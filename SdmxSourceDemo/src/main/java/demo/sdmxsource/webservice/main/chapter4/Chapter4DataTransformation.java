...
public class Chapter4DataTransformation {
	...
	public static void main(String[] args) {
            ...
            ClassPathXmlApplicationContext applicationContext =new ClassPathXmlApplicationContext("spring/spring-beans-chapter1.xml");
            //Step 2 - Get the main class from the Spring beans container
            Chapter4DataTransformation main =applicationContext.getBean(Chapter4DataTransformation.class);
